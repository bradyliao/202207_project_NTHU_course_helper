...
def course_data_processer(data_folder_path, global_semester):
    ...
    print(datetime.datetime.now().strftime("%Y-%m-%d %H:%M:%S") + " course_data_processer - start")
    ...
    print(datetime.datetime.now().strftime("%Y-%m-%d %H:%M:%S") + " course_data_processer - done")