...
def course_merge(data_folder_path, global_semester, selection_system_on, GPArecord_url, syllabus_activity_url): 
    ...
    # for row in range(0, 50):
        ...
        newData.append([display_course_ID, display_info, display_enrollment, display_other, department, gen_cat, chance, building, language, extra_enrollment, 
                        filter_course,
                        Monday,
    ...
    course_merged.columns = ['課號 Course ID', '課程資訊 Course Info', '註冊資訊 Enrollment Info', '其他 Other', '系所 Department', '通識 GE', '選上機率\nChance', '教室大樓 Building', '授課語言 Language', '加簽 Extra Enrollment', 
                            '課程 Course ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------',
                            'Monday -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------', 
                            'M1', 'M2', 'M3', 'M4', 'Mn', 'M5', 'M6', 'M7', 'M8', 'M9', 'Ma', 'Mb', 'Mc', 
                            'Tuesday -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------', 
